...
<?php else : ?>
    <div class="alert alert-info text-center">
        ...
        <a href="<?= base_url('auth'); ?>" class="d-block small font-weight-bold">Sign in</a>
    </div>
<?php endif; ?>
                ...
                <div class="divide-y-4" id="c<?= $c->comment_id; ?>">
                    <div>
                        <div class="row">
                            <div class="col-auto">
                                <?php if ($c->avatar) : ?>
                                    <span class="avatar mr-3 rounded-circle" style="background-image: url(<?= base_url('assets/images/users/') . $c->avatar ?>)"></span>
                                <?php else : ?>
                                    <span class="avatar mr-3 rounded-circle bg-blue-lt"><?= user_initial($c->username); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="col">
                                <div class="text-truncate">
                                    <strong><?= $c->username ? $c->username : "Anonymous"; ?></strong>
                                    <p><?= $c->comment_body; ?></p>
                                </div>
                                        ...
                                        <div>
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <?php else : ?>
                                                        <span class="avatar mr-3 rounded-circle bg-blue-lt"><?= user_initial($reply->username); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                <div class="col">
                                                    <div class="text-truncate">
                                                        <strong><?= $reply->username ? $reply->username : "Anonymous"; ?></strong>
